    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full glass-panel rounded-2xl p-8 animate-fade-up">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">Sign in to your Foodity account</p>
        </div>
        ...
        <button onClick={handleGoogleLogin} type="button" className="mt-6 w-full flex items-center justify-center gap-3 bg-white dark:bg-dark-700 border border-gray-200 dark:border-dark-600 text-gray-700 dark:text-gray-200 rounded-xl py-3 hover:bg-gray-50 dark:hover:bg-dark-600 transition-colors font-medium">
